 ...
 Page({
   ...
   goWriteOffSettlement (e) {
    ...
    list.push(order);
     ...
     let shopAddressInfo = JSON.stringify(this.data.addressInfo)
     wx.navigateTo({
       url: '../sureOrderNew/index?orderList=' + selectList + '&cart=' + cartData + '&schoolId=' + this.data.schoolId + '&shopId=' + this.data.shopId + '&shopName=' + this.data.shopName + '&surcharge=' + tosurcharge + '&surchargeConfig=' + surchargeConfig + '&type=arrival&detail=' + detail + '&shopAddressInfo=' + shopAddressInfo
     })
   },
   // 确认修改
   goEditOrder() {
